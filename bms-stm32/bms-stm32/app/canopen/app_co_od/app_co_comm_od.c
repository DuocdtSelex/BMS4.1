...
OD_Communication_Profile_Init_Data_t od_comm_prof_init_data =
{
	...
	.x1009_hardware_version = BMS_HW_VERSION,			//<< EDITABLE
...
//    },
	...
	.x180x_tpdo_comm_para[4] = {				//<< EDITABLE:
			.id = {
					.node_id = NODE_ID_DEFAULT ,
					.func_code =  0x00000200 >>7,
					.reverse1 = 0,
					.bit_frame = CO_BIT_CAN_FRAME_11BIT,
					.bit_30 = CO_BIT_RTR_NOT_ALLOW,
					.valid = CO_CF_180300_TPDO4_ENABLE				//<< EDITABLE:
	...
	/* TPDO6 Communication Parameter*/
	.x180x_tpdo_comm_para[5] = {				//<< EDITABLE:
			.id = {
					.node_id = NODE_ID_DEFAULT ,
					.func_code =  0x00000300 >>7,
					.reverse1 = 0,
					.bit_frame = CO_BIT_CAN_FRAME_11BIT,
					.bit_30 = CO_BIT_RTR_NOT_ALLOW,
					.valid = CO_CF_180300_TPDO4_ENABLE				//<< EDITABLE:
